...
<a class="navbar-brand" href="<?php echo e(isset($backto) ? $backto : route('userHome')); ?>"><i class="fa fa-chevron-left"></i></a><span class="text-white">我要出租</span>
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="row">
                <div class="col-md-12 input-group mb-3">
                    ...
                    <select name="house_type" class="custom-select" aria-describedby="basic-addon2"> 
                    <option value="别墅" 
