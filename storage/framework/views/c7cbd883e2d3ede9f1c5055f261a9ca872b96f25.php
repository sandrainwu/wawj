...
<a class="navbar-brand" href="<?php echo e(isset($backto) ? $backto : route('userHome')); ?>"><i class="fa fa-chevron-left"></i></a><span class="text-white">我要卖房</span>
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="row">
                <div class="col-md-12 input-group mb-3">
                    ...
                    <select name="house_type" aria-describedby="basic-addon2" class="form-control"> 
                        <option value="别墅" 
                        <?php if( isset($list->house_type) ): ?>
                            <?php if($list->house_type == '别墅'): ?>
                                selected
                            <?php endif; ?>
                        <?php endif; ?> 
                        >别墅</option>
            ...
            <div class="row">
                <div class="col-md-12 input-group mb-3">
                    ...
                    <input placeholder="售价" type="tel" class="form-control<?php echo e($errors->has('price') ? ' is-invalid' : ''); ?>" name="price" value="<?php echo e(isset($list->price) ? $list->price : old('price')); ?>" required aria-describedby="basic-addon4">
                    <div class="input-group-append">
