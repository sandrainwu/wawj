...
<a class="navbar-brand" href="<?php echo e(isset($backto) ? $backto : route('userHome')); ?>"><i class="fa fa-chevron-left"></i></a><span class="text-white">我要买房</span>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('content'); ?>
<br>
<form action="<?php echo e(route('messageSave')); ?>" method="post">
        ...
        <div class="col-md-6 offset-md-3">
            ...
            <div class="row">
                <div class="col-md-12 input-group mb-3">
                    ...
                    <input placeholder="建筑面积" type="number" class="form-control<?php echo e($errors->has('area') ? ' is-invalid' : ''); ?>" name="area" value="<?php echo e(isset($list->area) ? $list->area : old('area')); ?>" required aria-describedby="basic-addon3">
            ...
            <div class="row">
                <div class="col-md-12 input-group mb-3">
                    ...
                    <input placeholder="总价" type="number" class="form-control<?php echo e($errors->has('price') ? ' is-invalid' : ''); ?>" name="price" value="<?php echo e(isset($list->price) ? $list->price : old('price')); ?>" required aria-describedby="basic-addon4">
                    <div class="input-group-append">
            ...
            <div class="row">
                <div class="col-md-12 input-group mb-3">
                    ...
                    <input placeholder="房屋特点" type="text" class="form-control<?php echo e($errors->has('feature') ? ' is-invalid' : ''); ?>" name="feature" value="<?php echo e(isset($list->feature) ? $list->feature : old('feature')); ?>" required aria-describedby="basic-addon6">
                </div>
            </div>
