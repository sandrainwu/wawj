...
<script src="<?php echo e(asset('js/component/modal.js')); ?>"></script>
<script type="text/javascript">
  var vm = new Vue({
      ...
      mounted() {
          axios.put("<?php echo e($_SERVER['REQUEST_URI']); ?>",).then(function (res) {
                vm.users = res.data;
          })
      },
      methods:{
        ...
        search:function(){
          axios.put("<?php echo e($_SERVER['REQUEST_URI']); ?>", {pagesize:10,field:vm.field,keyword:vm.keyword})
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.baseframevue', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>