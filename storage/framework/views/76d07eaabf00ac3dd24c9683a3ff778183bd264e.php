            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="input-group justify-content-between">
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary"><i class="fa fa-weixin fa-lg"></i> <span class="small">微信</span></a>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary"><i class="fa fa-qq fa-lg"></i> <span class="small">&nbsp;QQ&nbsp;&nbsp;</span></a>
                        <a href="<?php echo e(route('login')); ?>" class="btn btn-outline-secondary"><i class="fa fa-weibo fa-lg"></i> <span class="small">微博</span></a>
                    </div>
                </div>
            </div>
