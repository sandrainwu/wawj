...
@section('top_title')
<a class="navbar-brand" href="{{ route('/') }}"><img alt="Brand" src="{{ asset('img/wawj.svg') }}" width="30" height="30" class="d-inline-block align-top"> 我爱我家</a><span class="text-white">系统管理员-{{ Auth::user()->real_name }}</span>
@endsection
...
<div class="tab-content" id="pills-tabContent">
    ...
    <div class="tab-pane" id="pills-contacts" role="tabpanel" aria-labelledby="pills-contacts-tab">
        ...
        <div class="container">
            ...
            <br>
            <div class="row border-top border-bottom">
                <div class="w-100 my-2 text-center"><a href="{{ route('logout','admin') }}" class="text-secondary">退出登录<i class="fa fa-lock fa-fw"></i></a></div>
            </div>
        </div>
    </div>
    <!-- 第4个tab -->
