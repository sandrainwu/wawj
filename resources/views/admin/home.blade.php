...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('adminlte/css/all-skins.min.css') }}">
                            ...
                            <li>
                                ...
                                <ul class="menu">
                                    <li><!-- start message -->
                                        <a href="#">
                                            <div class="pull-left">
                                                <img src="{{ asset('adminlte/img/avatar04.png') }}" class="img-circle"
                                                     alt="User Image">
                                            </div>
                                            <h4>
                                                Support Team
...
<!--tabs-->
<script src="{{ asset('adminlte/js/app_iframe.js') }}"></script>
